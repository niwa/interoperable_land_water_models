...
!BL
    ...
    !        string
    !    !CALL EXIT_TOPNET(1,'program terminated by assert1')
    !    CALL EXIT(1)
    !end if
...
!        write (*,*) 'nrerror: an assertion failed with this tag:', &
!            string
!        CALL EXIT(1) !CALL EXIT_TOPNET(1,'program terminated by assert2')
!    end if
...
!        write (*,*) 'nrerror: an assertion failed with this tag:', &
!            string
!        CALL EXIT(1) !CALL EXIT_TOPNET(1,'program terminated by assert3')
!    end if
...
!        write (*,*) 'nrerror: an assertion failed with this tag:', &
!            string
!        CALL EXIT(1) !CALL EXIT_TOPNET(1,'program terminated by assert4')
!    end if
...
!        write (*,*) 'nrerror: an assertion failed with this tag:', &
!            string
!        CALL EXIT(1) !CALL EXIT_TOPNET(1,'program terminated by assert_v')
!    end if
...
!BL
    ...
    if (n1 == n2) then
        ...
        write (*,*) 'nrerror: an assert_eq failed with this tag:', &
            string
        CALL EXIT(1) !CALL EXIT_TOPNET(1,'program terminated by assert_eq2')
    end if
...
!BL
    ...
    if (n1 == n2 .and. n2 == n3) then
        ...
        write (*,*) 'nrerror: an assert_eq failed with this tag:', &
            string
        CALL EXIT(1) !CALL EXIT_TOPNET(1,'program terminated by assert_eq3')
    end if
...
!BL
    ...
    if (n1 == n2 .and. n2 == n3 .and. n3 == n4) then
        ...
        write (*,*) 'nrerror: an assert_eq failed with this tag:', &
            string
        CALL EXIT(1) !CALL EXIT_TOPNET(1,'program terminated by assert_eq4')
    end if
...
!BL
    ...
    if (all(nn(2:) == nn(1))) then
        ...
        write (*,*) 'nrerror: an assert_eq failed with this tag:', &
            string
        CALL EXIT(1) !CALL EXIT_TOPNET(1,'program terminated by assert_eqn')
    end if
...
!BL
    ...
    CALL EXIT(1) !CALL EXIT_TOPNET(1,'program terminated by nrerror')
