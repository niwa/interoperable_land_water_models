  ...
  double precision,              target :: theta(:)         !< [rad] wave angles directional distribution w.r.t. comp. x-axis {"shape": ["s%ntheta"], "standard_name": "sea_surface_wind_wave_to_direction", "broadcast": "b"}
